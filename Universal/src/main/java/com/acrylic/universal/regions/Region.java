...
public interface Region {
    ...
    default Location[] getCorners() {
        final Location[] corners = new Location[8];
        ...
        corners[1] = new Location(world, x1, y2, z1);
        corners[2] = new Location(world, x2, y1, z1);
        corners[3] = new Location(world, x2, y2, z1);
        corners[4] = new Location(world, x1, y1, z2);
        corners[5] = new Location(world, x1, y2, z2);
        corners[6] = new Location(world, x2, y1, z2);
